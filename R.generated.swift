...
struct R: Rswift.Validatable {
  ...
  struct reuseIdentifier {
    ...
    static let settingsCell: Rswift.ReuseIdentifier<SettingsTableViewCell> = Rswift.ReuseIdentifier(identifier: "SettingsCell")
  ...
  struct string {
    ...
    /// This `R.string.common` struct is generated, and contains static references to 48 localization keys.
    struct common {
      /// en translation: Add
      ///
    ...
    /// This `R.string.homeView` struct is generated, and contains static references to 38 localization keys.
    struct homeView {
