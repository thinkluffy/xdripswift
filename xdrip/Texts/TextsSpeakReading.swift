...
enum Texts_SpeakReading {
    ...
    static var high: String {
        get {
            NSLocalizedString("high", tableName: filename, bundle: bundle!, value: "high", comment: "the word high")
        }
    }

    static var low: String {
        get {
            NSLocalizedString("low", tableName: filename, bundle: bundle!, value: "low", comment: "the word low")
        }
    }

    static var currentGlucose: String {
        get {
            NSLocalizedString("currentglucose", tableName: filename, bundle: bundle!, value: "Your current blood glucose is", comment: "For speak reading functionality")
        }
    }

    static var currentTrend: String {
        get {
            NSLocalizedString("currenttrend", tableName: filename, bundle: bundle!, value: "It's trending", comment: "For speak reading functionality")
        }
    }

    static var currentDelta: String {
        get {
            NSLocalizedString("currentdelta", tableName: filename, bundle: bundle!, value: "It's trending", comment: "For speak reading functionality")
        }
    }

    static var trendnoncomputable: String {
        get {
            NSLocalizedString("trendnoncomputable", tableName: filename, bundle: bundle!, value: "non computable", comment: "For speak reading functionality")
        }
    }

    static var deltanoncomputable: String {
        get {
            NSLocalizedString("deltanoncomputable", tableName: filename, bundle: bundle!, value: "non computable", comment: "For speak reading functionality")
        }
    }

    static var trenddoubledown: String {
        get {
            NSLocalizedString("trenddoubledown", tableName: filename, bundle: bundle!, value: "dramatically downward", comment: "For speak reading functionality")
        }
    }

    static var trendsingledown: String {
        get {
            NSLocalizedString("trendsingledown", tableName: filename, bundle: bundle!, value: "significantly downward", comment: "For speak reading functionality")
        }
    }

    static var trendfortyfivedown: String {
        get {
            NSLocalizedString("trendfortyfivedown", tableName: filename, bundle: bundle!, value: "down", comment: "For speak reading functionality")
        }
    }

    static var trendflat: String {
        get {
            NSLocalizedString("trendflat", tableName: filename, bundle: bundle!, value: "flat", comment: "For speak reading functionality")
        }
    }

    static var trendfortyfiveup: String {
        get {
            NSLocalizedString("trendflat", tableName: filename, bundle: bundle!, value: "up", comment: "For speak reading functionality")
        }
    }

    static var trendsingleup: String {
        get {
            NSLocalizedString("trendsingleup", tableName: filename, bundle: bundle!, value: "significantly upward", comment: "For speak reading functionality")
        }
    }

    static var trenddoubleup: String {
        get {
            NSLocalizedString("trenddoubleup", tableName: filename, bundle: bundle!, value: "dramatically upward", comment: "For speak reading functionality")
        }
    }
