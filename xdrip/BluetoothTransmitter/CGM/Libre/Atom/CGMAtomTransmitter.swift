                    ...
                    case .dataPacket:
                        ...
                        if rxBuffer.count >= 344  {
                            ...
                            if let libreSensorType = LibreSensorType.type(patchInfo: patchInfo), let sensorSerialNumberAsData = sensorSerialNumberAsData {
                                ...
                                dataIsDecryptedToLibre1Format = libreSensorType.decryptIfPossibleAndNeeded(rxBuffer: &rxBuffer[0..<344], headerLength: 0, log: log, patchInfo: patchInfo, uid: [UInt8](sensorSerialNumberAsData))
