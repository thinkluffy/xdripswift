...
class CommonSettingsViewController: SubSettingsViewController {
    ...
    private let tableCellIdNotificationInterval = 1
    ...
    private func buildDataOfGeneral(builder: TableDataBuilder) -> TableDataBuilder {
        builder
                ...
                .toggleCell(title: R.string.settingsViews.settingsviews_showReadingInNotification(),
                        ...
                        toggleDidChange: {
                            [unowned self] toggleCell, from, to in

                            UserDefaults.standard.showReadingInNotification = to
                            let notificationIntervalCell = tableData.tableCell(ofCellId: tableCellIdNotificationInterval)
                            notificationIntervalCell?.isHidden = !to
                            tableView.reloadSections(IndexSet(integer: 0), with: .none)
                        })
                .operationCell(id: tableCellIdNotificationInterval,
                        ...
                        isHidden: !UserDefaults.standard.showReadingInNotification,
                        didClick: {
                ...
                .toggleCell(title: R.string.settingsViews.settingsviews_labelShowReadingInAppBadge(),
                        isOn: UserDefaults.standard.showReadingInAppBadge, toggleDidChange: { toggleCell, from, to in
                        ...
                        didClick: {
                            ...
                            let pickerViewData = PickerViewDataBuilder(
                                ...
                                if height < UserDefaults.standard.urgentHighMarkValue {
                                    view.makeToast(R.string.settingsViews.toast_chart_height_smaller_than_urgent_high(),
                                            duration: 4,
                                            position: .bottom)
                                    return
                                }
