...
extension Libre2BluetoothPeripheralViewModel: BluetoothPeripheralViewModel {
    ...
    func update(cell: UITableViewCell, forRow rawValue: Int, forSection section: Int, for bluetoothPeripheral: BluetoothPeripheral) {
        ...
        guard let setting = Settings(rawValue: rawValue) else {
            fatalError("Libre2BluetoothPeripheralViewModel update, unexpected setting")
        }
    ...
    func userDidSelectRow(withSettingRawValue rawValue: Int, forSection section: Int, for bluetoothPeripheral: BluetoothPeripheral, bluetoothPeripheralManager: BluetoothPeripheralManaging) -> SettingsSelectedRowAction {
        ...
        guard let setting = Settings(rawValue: rawValue) else {
            fatalError("Libre2BluetoothPeripheralViewModel userDidSelectRow, unexpected setting")
        }
