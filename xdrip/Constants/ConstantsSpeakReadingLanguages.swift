...
enum ConstantsSpeakReadingLanguages: String, CaseIterable {
    ...
    case polish = "Polskie/pl-PL"
    case portugese_portugal = "Português/pt"
    case portugese_brasil = "Português (Brasil)/pt-BR"
    case russian = "Pусский/ru"
    case slovenian = "Slovenščina/sl"
    case spanish_mexico = "Español (México)/es-MX"
    case spanish_spain = "Español (España)/es-ES"
